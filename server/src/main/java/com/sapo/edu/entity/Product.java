...
public class Product extends BaseEntity {
    ...
    @JoinTable(name = "products_models", joinColumns = {@JoinColumn(name = "product_id", referencedColumnName = "id")}, inverseJoinColumns = {@JoinColumn(name = "model_id", referencedColumnName = "id")})
