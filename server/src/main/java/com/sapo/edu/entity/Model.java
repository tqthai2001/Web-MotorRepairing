...
public class Model extends BaseEntity {
    ...
    private Set<Product> products = new HashSet<>(); // reference part in ManyToMany relation with Product
    ...
    public String toString() {
        return "Model{" + "brand=" + brand.getBrandName() + ", modelName='" + modelName + '\'' + ", products=" + products.stream()
                .map(item -> item.getName())
                .collect(Collectors.toSet()) + ", id=" + id + '}';
    }
}
