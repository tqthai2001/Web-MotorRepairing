...
public class TicketDTOMapper {
    ...
    public TicketDTO toTicketDTO(Ticket ticket) {
        ...
        propertyMapper.addMappings(mapper -> {
            ...
            mapper.using(context -> context.getSource() == null ? null
                                                                : customerDTOMapper.toCustomerDTO((Customer) context.getSource()))
                    .map(Ticket::getCustomer, TicketDTO::setCustomer);
            mapper.using(context -> context.getSource() == null ? null
                                                                : employeeDTOMapper.toEmployeeDTO((Employee) context.getSource()))
